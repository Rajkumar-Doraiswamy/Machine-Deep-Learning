...
Ref: Page 143 (Section 5.3) of Book 'Deep Learning with python'
     by Francois Chollet
Data from Kaggle: https://www.kaggle.com/c/invasive-species-monitoring

Objective:
		i) Invasive Species Monitoring
        ii)Transfer Learning: Building powerful image classification
...
# 2.1 Where are invasive and non-invasive?
...
nb_train_samples, nb_validation_samples = 2000, 295


# 2.4 Predict in batches that fit RAM
#     and also sample-size is fully divisible by it
batch_size_train = 16         # Maybe for 4GB machine, batch-size of 32 will be OK
batch_size_valid = 5
...
nb_train_samples = 2000        # 1263+737
nb_validation_samples = 295    # 185+110
epochs = 50
batch_size = 16
...
train_labels = np.array([0] * 1263 + [1] * 737)   # Try [0] * 3 + [1] * 5
